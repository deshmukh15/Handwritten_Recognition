...
import numpy as np 
from collections import deque   # ocncept of stack or queue
...
def keras_process_image(img):
	...
	img = np.reshape(img, (-1, image_x, image_y, 1))   # -1 is for getting the last value of array , 1 for number of channel
	return img
